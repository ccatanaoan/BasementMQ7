...
B4R::Common::LogHelper(1,102,F("Connected to broker"));
 //BA.debugLineNum = 129;BA.debugLine="MQTT.Subscribe(\"MQ7Basement\", 0)";
b4r_main::_mqtt->Subscribe(be_ann87_4.wrap("MQ7Basement"),(Byte) (0));
 };
...
B4R::Common::LogHelper(4,102,F("Message arrived. Topic="),101,_topic->data,102,F(" Payload="),100,be_ann91_8.wrapPointer(_payload));
 //BA.debugLineNum = 136;BA.debugLine="If Topic = \"MQ7Basement\" Then";
if ((_topic)->equals(be_ann92_3.wrap("MQ7Basement"))) { 
...
if (b4r_main::_wifi->getIsConnected()) { 
 //BA.debugLineNum = 147;BA.debugLine="MQTT.Publish(\"MQ7Basement\",s)";
b4r_main::_mqtt->Publish(be_ann100_4.wrap("MQ7Basement"),(_s)->GetBytes());
 };
 };
 }else if((_payload)->equals((be_ann103_3.wrap("Restart controller"))->GetBytes())) { 
 //BA.debugLineNum = 152;BA.debugLine="MQTT.Publish(\"MQ7Basement\",\"Restarting controll";
...
b4r_main::_mqttport = 11816;
 //BA.debugLineNum = 35;BA.debugLine="Private WiFiSSID As String = \"IoT2G\"";
b4r_main::_wifissid = be_gann12_5.wrap("IoT2G");
 //BA.debugLineNum = 36;BA.debugLine="Private WiFiPassword As String = \"SteelReserveIOT";
b4r_main::_wifipassword = be_gann13_5.wrap("SteelReserveIOT1980");
...
if (b4r_main::_wifi->getIsConnected()) { 
 //BA.debugLineNum = 97;BA.debugLine="MQTT.Publish(\"MQ7Basement\",s)";
